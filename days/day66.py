...
#button = tk.Button(text="Click me!", #command=update_label).grid(row=2,column=0)
## button.pack(side=tk.BOTTOM)
#button = tk.Button(text="Button!", #command=update_label).grid(row=2,column=1)
#button = tk.Button(text="More button", #command=update_label).grid(row=2,column=2)
